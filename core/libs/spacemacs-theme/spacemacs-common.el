...
(defun create-spacemacs-theme (variant theme-name)
  (let ((class '((class color) (min-colors 89))) ;;              ~~ Dark ~~                              ~~ Light ~~
        ;;                                                          GUI       TER                           GUI       TER
        ;; generic
        (act1          (if (eq variant 'dark) (if (true-color-p) "#121212" "#121212") (if (true-color-p) "#d7dfff" "#d7dfff")))
        (act2          (if (eq variant 'dark) (if (true-color-p) "#444444" "#444444") (if (true-color-p) "#afafd7" "#afafd7")))
        (base          (if (eq variant 'dark) (if (true-color-p) "#b2b2b2" "#b2b2b2") (if (true-color-p) "#5f5f87" "#5f5f87")))
        (base-dim      (if (eq variant 'dark) (if (true-color-p) "#585858" "#585858") (if (true-color-p) "#afafd7" "#afafd7")))
        (bg1           (if (eq variant 'dark) (if (true-color-p) "#262626" "#262626") (if (true-color-p) "#ffffff" "#ffffff")))
        (bg2           (if (eq variant 'dark) (if (true-color-p) "#1c1c1c" "#1c1c1c") (if (true-color-p) "#e4e4e4" "#e4e4e4")))
        (bg3           (if (eq variant 'dark) (if (true-color-p) "#121212" "#121212") (if (true-color-p) "#d0d0d0" "#d0d0d0")))
        (bg4           (if (eq variant 'dark) (if (true-color-p) "#080808" "#080808") (if (true-color-p) "#bcbcbc" "#bcbcbc")))
        (bg-alt        (if (eq variant 'dark) (if (true-color-p) "#353535" "#353535") (if (true-color-p) "#e4e4e4" "#e4e4e4")))
        (border        (if (eq variant 'dark) (if (true-color-p) "#111111" "#111111") (if (true-color-p) "#b3b9be" "#b3b9be")))
        (cblk          (if (eq variant 'dark) (if (true-color-p) "#b2b2b2" "#b2b2b2") (if (true-color-p) "#5f5f87" "#5f5f87")))
        (cblk-bg       (if (eq variant 'dark) (if (true-color-p) "#262626" "#262626") (if (true-color-p) "#ffffff" "#ffffff")))
        (cblk-ln       (if (eq variant 'dark) (if (true-color-p) "#af5faf" "#af5faf") (if (true-color-p) "#af5fdf" "#af5fdf")))
        (cblk-ln-bg    (if (eq variant 'dark) (if (true-color-p) "#333333" "#333333") (if (true-color-p) "#dfdfff" "#dfdfff")))
        (cursor        (if (eq variant 'dark) (if (true-color-p) "#d0d0d0" "#d0d0d0") (if (true-color-p) "#121212" "#121212")))
        (const         (if (eq variant 'dark) (if (true-color-p) "#d75fd7" "#d75fd7") (if (true-color-p) "#8700af" "#8700af")))
        (comment       (if (eq variant 'dark) (if (true-color-p) "#008787" "#008787") (if (true-color-p) "#008787" "#008787")))
        (comment-light (if (eq variant 'dark) (if (true-color-p) "#008787" "#008787") (if (true-color-p) "#008787" "#008787")))
        (comment-bg    (if (eq variant 'dark) (if (true-color-p) "#262626" "#262626") (if (true-color-p) "#ffffff" "#ffffff")))
        (comp          (if (eq variant 'dark) (if (true-color-p) "#d75fd7" "#d75fd7") (if (true-color-p) "#8700af" "#8700af")))
        (err           (if (eq variant 'dark) (if (true-color-p) "#e0211d" "#e0211d") (if (true-color-p) "#e0211d" "#e0211d")))
        (func          (if (eq variant 'dark) (if (true-color-p) "#d75fd7" "#d75fd7") (if (true-color-p) "#8700af" "#8700af")))
        (head1         (if (eq variant 'dark) (if (true-color-p) "#268bd2" "#268bd2") (if (true-color-p) "#268bd2" "#268bd2")))
        (head1-bg      (if (eq variant 'dark) (if (true-color-p) "#262626" "#262626") (if (true-color-p) "#ffffff" "#ffffff")))
        (head2         (if (eq variant 'dark) (if (true-color-p) "#2aa198" "#2aa198") (if (true-color-p) "#2aa198" "#2aa198")))
        (head2-bg      (if (eq variant 'dark) (if (true-color-p) "#262626" "#262626") (if (true-color-p) "#ffffff" "#ffffff")))
        (head3         (if (eq variant 'dark) (if (true-color-p) "#67b11d" "#67b11d") (if (true-color-p) "#5faf00" "#5faf00")))
        (head3-bg      (if (eq variant 'dark) (if (true-color-p) "#262626" "#262626") (if (true-color-p) "#ffffff" "#ffffff")))
        (head4         (if (eq variant 'dark) (if (true-color-p) "#875f00" "#875f00") (if (true-color-p) "#875f00" "#875f00")))
        (head4-bg      (if (eq variant 'dark) (if (true-color-p) "#262626" "#262626") (if (true-color-p) "#ffffff" "#ffffff")))
        (highlight     (if (eq variant 'dark) (if (true-color-p) "#444444" "#444444") (if (true-color-p) "#d7d7ff" "#d7d7ff")))
        (highlight-dim (if (eq variant 'dark) (if (true-color-p) "#444444" "#444444") (if (true-color-p) "#d7d7ff" "#d7d7ff")))
        (keyword       (if (eq variant 'dark) (if (true-color-p) "#268bd2" "#268bd2") (if (true-color-p) "#268bd2" "#268bd2")))
        (lnum          (if (eq variant 'dark) (if (true-color-p) "#444444" "#444444") (if (true-color-p) "#af87af" "#af87af")))
        (mat           (if (eq variant 'dark) (if (true-color-p) "#86dc2f" "#86dc2f") (if (true-color-p) "#af005f" "#af005f")))
        (meta          (if (eq variant 'dark) (if (true-color-p) "#af875f" "#af875f") (if (true-color-p) "#df5f5f" "#df5f5f")))
        (str           (if (eq variant 'dark) (if (true-color-p) "#2aa198" "#2aa198") (if (true-color-p) "#2aa198" "#2aa198")))
        (suc           (if (eq variant 'dark) (if (true-color-p) "#86dc2f" "#86dc2f") (if (true-color-p) "#00af00" "#00af00")))
        (ttip          (if (eq variant 'dark) (if (true-color-p) "#888888" "#888888") (if (true-color-p) "#5f5f87" "#5f5f87")))
        (ttip-sl       (if (eq variant 'dark) (if (true-color-p) "#333333" "#333333") (if (true-color-p) "#afafff" "#afafff")))
        (ttip-bg       (if (eq variant 'dark) (if (true-color-p) "#444444" "#444444") (if (true-color-p) "#dfdfff" "#dfdfff")))
        (type          (if (eq variant 'dark) (if (true-color-p) "#df005f" "#df005f") (if (true-color-p) "#af005f" "#af005f")))
        (var           (if (eq variant 'dark) (if (true-color-p) "#8787d7" "#8787d7") (if (true-color-p) "#af5fd7" "#af5fd7")))
        (war           (if (eq variant 'dark) (if (true-color-p) "#dc752f" "#dc752f") (if (true-color-p) "#dc752f" "#dc752f")))

        ;; colors
        (aqua          (if (eq variant 'dark) (if (true-color-p) "#2aa198" "#2aa198") (if (true-color-p) "#2aa198" "#2aa198")))
        (aqua-bg       (if (eq variant 'dark) (if (true-color-p) "#262626" "#262626") (if (true-color-p) "#ffffff" "#ffffff")))
        (green         (if (eq variant 'dark) (if (true-color-p) "#67b11d" "#67b11d") (if (true-color-p) "#5faf00" "#5faf00")))
        (green-bg      (if (eq variant 'dark) (if (true-color-p) "#262626" "#262626") (if (true-color-p) "#ffffff" "#ffffff")))
        (green-bg-s    (if (eq variant 'dark) (if (true-color-p) "#262626" "#262626") (if (true-color-p) "#ffffff" "#ffffff")))
        (cyan          (if (eq variant 'dark) (if (true-color-p) "#00ffff" "#00ffff") (if (true-color-p) "#008080" "#008080")))
        (red           (if (eq variant 'dark) (if (true-color-p) "#d70000" "#d70000") (if (true-color-p) "#d70008" "#d70008")))
        (red-bg        (if (eq variant 'dark) (if (true-color-p) "#262626" "#262626") (if (true-color-p) "#ffffff" "#ffffff")))
        (red-bg-s      (if (eq variant 'dark) (if (true-color-p) "#262626" "#262626") (if (true-color-p) "#ffffff" "#ffffff")))
        (blue          (if (eq variant 'dark) (if (true-color-p) "#268bd2" "#268bd2") (if (true-color-p) "#268bd2" "#268bd2")))
        (blue-bg       (if (eq variant 'dark) (if (true-color-p) "#262626" "#262626") (if (true-color-p) "#d7d7ff" "#d7d7ff")))
        (blue-bg-s     (if (eq variant 'dark) (if (true-color-p) "#262626" "#262626") (if (true-color-p) "#d7d7ff" "#d7d7ff")))
        (magenta       (if (eq variant 'dark) (if (true-color-p) "#af00df" "#af00df") (if (true-color-p) "#800080" "#800080")))
        (yellow        (if (eq variant 'dark) (if (true-color-p) "#875f00" "#875f00") (if (true-color-p) "#875f00" "#875f00")))
        (yellow-bg     (if (eq variant 'dark) (if (true-color-p) "#262626" "#262626") (if (true-color-p) "#ffffff" "#ffffff"))))
...
;;;;; magit
     ...
     `(magit-diff-added-highlight   ((,class :background ,bg2 :inherit diff-added)))
     `(magit-diff-removed           ((,class :inherit diff-removed)))
     `(magit-diff-removed-highlight   ((,class :background ,bg2 :inherit diff-removed)))
...
;;;;; mode-line
     ...
     `(mode-line-inactive  ((,class (:foreground ,base :background ,bg2  :box (:color ,border :line-width 1)))))
